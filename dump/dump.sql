...
(515, 'bank_id', 'i18n::field-bank_id', 0, 20, 0, 1, NULL, 0, 0, 'Код процессингового центра \"ЮMoney\"', 0, NULL, 0, 0, 0),
...
(521, 'shop_id', 'i18n::field-yandex-kassa-shop-id', 1, 20, 0, 1, NULL, 0, 0, 'Идентификатор вашего магазина в ЮKassa', 1, NULL, 0, 0, 1),
(522, 'secret_key', 'i18n::field-yandex-kassa-secret-key', 1, 20, 0, 1, NULL, 0, 0, 'Выпустить секретный ключ можно в личном кабинете ЮKassa, в разделе \"Настройки\"', 1, NULL, 0, 0, 1),
